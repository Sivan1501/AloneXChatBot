# Don't remove This Line From Here. Tg: @ALONE_WAS_BOT | @ALONE_WAS_BOT
# Github :- TeamAloneOp | AloneXChatBot
...
from Alone import AloneBot
from Alone.modules.helpers import CHATBOT_ON, is_admins


@AloneBot.on_cmd("chatbot", group_only=True)
